...
function cwf_init_shortcuts(){var a=function(){cwf_show_previous_photo("overflow")},b=function(){cwf_show_next_photo("overflow")},e=function(){cwf_show_photo(0)},d=function(){cwf_show_photo(photos.length-1)};$(document).keypress(function(c){if(c.keyCode==37)a();else if(c.keyCode==38)e();else if(c.keyCode==39)b();else c.keyCode==40&&d()});$(document).touchwipe({wipeLeft:b,wipeRight:a,wipeUp:e,wipeDown:d,min_move_x:20,min_move_y:20,preventDefaultEvents:true})}
