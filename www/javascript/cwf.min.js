...
function cwf_init_layout(){$("#content").hide();$("#main").css("background-color","transparent");$("#footer").css("opacity",".75");$("#main").append('<div id="cwf_about"></div>')}function cwf_init_shortcuts(){$(document).keypress(function(a){if(a.keyCode==37)cwf_show_previous_photo("overflow");else if(a.keyCode==38)cwf_show_photo(0);else if(a.keyCode==39)cwf_show_next_photo("overflow");else a.keyCode==40&&cwf_show_photo(photos.length-1)})}
...
'/faves/" target="_flickr">'+h+"</a>";msg+=' <span style="font-size:1.2em;font-weight:700;">\u2606</span>  ';msg+='<a href="http://www.flickr.com/photos/'+d+'/" target="_flickr">'+f+"</a><br />";msg+='no. <span id="cwf_photo_idx">'+a+'</span> of <span id="cwf_count_photos">'+photos.length+"</span> faves";if(a>1)msg+=' / <a href="#" onclick="cwf_show_next_photo();return false;">before</a>';if(a<count_photos)msg+=' / <a href="#" onclick="cwf_show_previous_photo();return false;">after</a>';msg+='<div id="cwf_updates"></div>';
msg+="</div>";$("#cwf_about").html("");$.backstretch(i);$("#cwf_about").html(msg)};
